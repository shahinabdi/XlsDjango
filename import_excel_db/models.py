...
class Data(models.Model):
    ...
    O17_Error = models.DecimalField(max_digits=18,decimal_places=10, null=True)
    ...
    #Properties Physic
    Percipitation_Amount = models.DecimalField(max_digits=18,decimal_places=10, null=True)
    Percipitation_Amount_Unit = models.CharField(max_length=255, null=True)
    Air_Temperature = models.DecimalField(max_digits=18,decimal_places=10, null=True)
    Air_Temperature_Unit = models.CharField(max_length=255, null=True)
    Vapor_Pressure = models.DecimalField(max_digits=18,decimal_places=10, null=True)
    Vapor_Pressure_Unit = models.CharField(max_length=255, null=True)
    Electric_Conductivity = models.DecimalField(max_digits=18,decimal_places=10, null=True)
